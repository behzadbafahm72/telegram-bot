...
TOKEN = "8801570761:AAE3Gm0vTAWOMGFWwqcd0ys63Z3FYYk4Dw0"
ADMIN_ID = 8879412585
...
plan_names = {
    "plan_10": "📦 10 گیگ - 100 تومان",
    "plan_20": "📦 20 گیگ - 200 تومان",
    "plan_30": "📦 30 گیگ - 250 تومان",
    "plan_unlimited1": "🚀 نامحدود یک ماهه (1 کاربر) - 400 تومان",
    "plan_unlimited2": "🔥 نامحدود یک ماهه (2 کاربر) - 700 تومان",
    "plan_unlimited3": "💎 نامحدود یک ماهه (3 کاربر) - 900 تومان"
}
...
🔥 مزایا:
✅ 10٪ حجم هدیه روی خرید مجدد
✅ هر 5 خرید = اشتراک هدیه رایگان
...
🎁 تا هدیه رایگان: {remaining} خرید دیگر

🚀 پاداش خرید بعدی: 10٪ حجم اضافه
"""
    if orders:
        text += "\n📋 سفارشات اخیر:\n"
